...
program grhd2
  ...
  if (nx > 1) then
      allocate(alpha_f_x,beta_f_x,gamma_f_x,sqrt_gamma_f_x)
  end if

  if (ny > 1) then
      allocate(alpha_f_y,beta_f_y,gamma_f_y,sqrt_gamma_f_y)
  end if

  if (nz > 1) then
      allocate(alpha_f_z,beta_f_z,gamma_f_z,sqrt_gamma_f_z)
  end if
